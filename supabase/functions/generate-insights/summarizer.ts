...
/**
 * Summarizes a long string of text using a map-reduce approach with Gemini.
 * @param transcriptText The full text to summarize.
...
export async function summarizeTextWithGemini(transcriptText: string) {
  ...
  // REDUCE PHASE: Combine summaries and get the final result
