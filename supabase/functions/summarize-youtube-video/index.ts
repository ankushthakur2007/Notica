...
// Helper function to break large text into smaller, overlapping chunks
...
// Main function to summarize text using a map-reduce approach with Gemini
async function summarizeTextWithGemini(transcriptText: string) {
  ...
  // "Reduce" step: Combine the chunk summaries into a final, cohesive output
  ...
  // Clean up potential markdown wrappers from the AI response
